...
*Kineviz* provides many flexible layout options for displaying the graph on the canvas, making it possible to create and share information-rich visualizations of your high-dimensional data. 
...
*Kineviz* automatically pins nodes when you:
