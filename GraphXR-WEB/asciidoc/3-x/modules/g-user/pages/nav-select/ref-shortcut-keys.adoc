...
| *_Ctrl_**+**_0_*
| Center the view on a selected node.
| Navigate
...
| Reset view
| *_Alt+Shift+R_*
| Reset entire view to the center of the graph. _NOTE: Click the *Fly Out* icon to center all the graph data on the screen, and the *Center To* icon to center the view on selected nodes._
| Navigate
...
| Open / Close Panel
| *_Cmd_*+*_B_*
| Toggle to close or reopen a panel docked to the left menu.
| Navigate

| Peek
| *_Shift_*+*_Z_*
| Toggle to show or hide all panels, to quickly view the data on the canvas.
| Navigate
...
| Expand
| *_Ctrl_**+**_X_*
| Display a dialog to pull nodes connected to the selected nodes based on relationships from the project's connected database.
| Select & Import
...
| Redo
| *_Ctrl+Y_*
| Immediately re-do an *_Undo_* action.
| Edit

| History
| *_Ctrl+Shift+H_*
| Dispay the *_History_* dialog to revert to an earlier state of the graph.
| Edit

| Encrypt / Decrypt a Property
| *_Shift+E_*
| Toggle to encrypt the values of a selected property.
| Edit

| Add Degree 
| *_Shift+Ctrl+D_*
| Add the *_degree_* property (i.e. the number of connected edges) to all nodes.
| Edit
