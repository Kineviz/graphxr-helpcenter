...
NOTE: *Kineviz Desktop* includes data editing features in its basic table, not in an enhanced table.
...
You can xref:transform-data/tr-merge.adoc[*_Merge_*] nodes or edges of a single category or relationship the using *_Merge_* transform, or quick merge selected nodes using the right-click *_Actions > Merge_*. 
