= GraphXR and Kineviz Desktop Release History

[cols="1,1,10"]
|===
|*Tag* |*Date* |*Release Highlights*

|xref:./gxr-3-22-0-release-notes.adoc[3.22.0] |6/30/2026 
a|* *Usability*
...
** *Kineviz Desktop* v.0.8.0 (beta) access, payment system, upgrade path, version usage, and agent feedback implemented through *Kineviz Cloud*.  
