...
a|* *Usability*
** *GraphXR Agent* add for AI-enabled enagement with graph visualization and analytics.
** Create View folders on the *View* menu to organize and save views for a specific manual or agentic workflow within a project.
