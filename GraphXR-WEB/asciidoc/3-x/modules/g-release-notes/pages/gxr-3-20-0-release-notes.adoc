...
* Views can be selected for automatic inclusion in a cloned project by setting a checkbox in the view's information dialog (GXR-4016).
+
...
+
image::/v3/V3_20_0_10_QueryHistory.png[,420,240,role=text-left]
