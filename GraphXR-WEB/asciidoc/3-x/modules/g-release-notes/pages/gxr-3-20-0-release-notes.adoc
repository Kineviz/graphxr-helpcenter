...
+
image::/v3/V3_20_0_02_Agent_Admin[,420,420,role=text-left]
+
...
+
image::/v3/V3_20_0_03_ExpandAll[,240,120,role=text-left]
+
...
+
image::/v3/V3_20_0_09_OtherMenuUser[,340,240,role=text-left]
+
...
** gxr.database() is removed to prevent confusion with gxr.query(). REFERENCE.md is updated (GXR-3971).
