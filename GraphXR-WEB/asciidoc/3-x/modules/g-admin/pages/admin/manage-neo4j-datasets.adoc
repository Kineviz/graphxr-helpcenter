...
image::/v3/04_01_Neo4jDBs.png[,720,420,role=text-left]
...
image::/v3/04_02_Neo4jDB_Add.png[,720,420,role=text-left]

NOTE: *_About Neo4J_*. Since Kineviz works seamlessly with Neo4j graph databases, you may want to investigate graph data modeling and database management as it applies to Neo4j.
