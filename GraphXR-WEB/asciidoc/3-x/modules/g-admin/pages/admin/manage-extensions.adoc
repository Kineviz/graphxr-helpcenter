...
In the *_Extensions_* panel, you can manage the extensions available to your Kineviz installation.

image::/v3/06_01_Extensions.png[,720,480,role=text-left]
...
* *_Search_* for extensions by time period, name or description, then *_Pull The Extensions From Kineviz Manager Server_*.
* *_Delete_* an extension from your installation.
* *_Edit_* the version of the extension being used.
+
image::/v3/06_04_Extensions_Edit.png[,720,480,role=text-left]

* Set up a list of authorized users, using *_Auth Users_*, either for selected extensions, or all extensions.
+
image::/v3/06_02_Extensions_AuthUsers.png[,720,420,role=text-left]

* *_Export_* extensions as a .zip archive. You can export selected extensions, or all extensions at once.
+
image::/v3/06_03_Extensions_Export.png[,720,420,role=text-left]
