...
* *_Tags_*: Enter a version tag to grant access to specific pre-release versions of GraphXR.
...
+
* *_Connector API Auth_*: Click  *_Disable_* or *_Enable_* to grant access to the third party *_Connector_* applications in a GraphXR Enterprise installation.
* *_API Key Access_*: Click  *_Disable_* or *_Enable_* to grant access to the GraphXR API via a key.
+
