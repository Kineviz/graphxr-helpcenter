= Kineviz Administration

Admin accounts can be provided for Kineviz multi-user installations. They are configured and registered during installation. However, admin privileges can be updated without requiring re-installation.
...
* Manage LLM connection to Kineviz.
+
